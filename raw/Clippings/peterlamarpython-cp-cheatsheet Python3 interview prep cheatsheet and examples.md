---
title: "peterlamar/python-cp-cheatsheet: Python3 interview prep cheatsheet and examples"
source: "https://github.com/peterlamar/python-cp-cheatsheet?tab=readme-ov-file#language-mechanics"
author:
published:
created: 2026-06-16
...
25. [Fibonacci Golden](#fibonacci-golden)
...
1. A [tree](https://www.geeksforgeeks.org/some-theorems-on-trees/) is an undirected [graph](https://www.cs.sfu.ca/~ggbaker/zju/math/trees.html) in which any two vertices are connected by exactly one path.
...
from typing import List, Set, Dict, Tuple, Optional [cheat sheet](https://mypy.readthedocs.io/en/stable/cheat_sheet_py3.html)
...
local\_maxiumum\[i\] = max(A\[i\], A\[i\] + local\_maximum\[i-1\]) [Explanation](https://medium.com/@rsinghal757/kadanes-algorithm-dynamic-programming-how-and-why-does-it-work-3fd8849ed73d) Determine max subarray sum

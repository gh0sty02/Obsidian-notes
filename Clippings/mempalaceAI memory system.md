---
title: "MemPalace/mempalace: The highest-scoring AI memory system ever benchmarked. And it's free."
source: https://github.com/MemPalace/mempalace
author:
published:
created: 2026-04-13
description: The highest-scoring AI memory system ever benchmarked. And it's free. - MemPalace/mempalace
tags:
  - clippings
---
...
| **96.6%**   <sub>LongMemEval R@5<br><b>raw mode</b>, zero API calls</sub> | **500/500**   <sub>questions tested<br>independently reproduced</sub> | **$0**   <sub>No subscription<br>No cloud. Local only.</sub> |
| --- | --- | --- |

<sub>Reproducible — runners in <a href="https://github.com/MemPalace/mempalace/blob/develop/benchmarks">benchmarks/</a>. <a href="https://github.com/MemPalace/mempalace/blob/develop/benchmarks/BENCHMARKS.md">Full results</a>. The 96.6% is from <b>raw verbatim mode</b>, not AAAK or rooms mode (those score lower — see <a href="#a-note-from-milla--ben--april-7-2026">note above</a>).</sub>
...
MemPalace also works natively with **Gemini CLI** (which handles the server and save hooks automatically) — see the [Gemini CLI Integration Guide](https://github.com/MemPalace/mempalace/blob/develop/examples/gemini_cli_setup.md).
...
### Wing config (~/.mempalace/wing\_config.json)
